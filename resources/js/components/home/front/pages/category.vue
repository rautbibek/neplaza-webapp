<template>
    <div>
        ...
        <div>
            ...
            <v-navigation-drawer v-model="subcategory" app bottom temporary>
                <v-list nav dense>
                    ...
                    >
                        <v-list-item
                            ...
                            :key="i"
                            router
                            :to="`/category/${category.id}/${scat.slug}`"
                        >
                            <v-list-item-icon>
            ...
            <div class="py-5" v-if="count > 0">
                <v-container>
                    <v-btn
                        ...
                        absolute
                        @click.stop="subcategory = !subcategory"
                        small
                        fab
                        bottom
                        left
...
export default {
    ...
    watch: {
        $route(to, from) {
            return this.fetch(
                `/front/category/product/${this.$route.params.slug}`
            );
        }
    }
};
