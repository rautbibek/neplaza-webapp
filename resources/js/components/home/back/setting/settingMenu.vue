<template>
<div>
  <v-navigation-drawer class="drawer d-none d-sm-flex" style="min-height:550px" absolute permanent>
    <v-list dense class="p-0 ">
      <v-list-item-group v-model="item" class="text-white">
  ...
  <div class="bottom-drawer d-flex d-sm-none">
      <v-btn
        small
        fab
        dark
